  ...
  <div class="col-md-12">
    <div class="card card-outline-info">
      ...
      <div class="card-body wizard-content">
        <form id="add_client" class="form-control-line" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('form input[type="text"], input[type="date"], input[type="file"], input[type="number"], input[type="url"], input[type="password"],  input[type="email"],  input[type="tel"], form textarea, form select').on('focus', function() {
    ...
    $('#add_client').on('submit', function(e) {
     ...
     $(this).find('input[type="text"], input[type="date"], input[type="file"], input[type="number"], input[type="password"], input[type="email"], input[type="tel"], input[type="url"], textarea, select, input[type="hidden"]').each(function() {
       if( $(this).val() == "" ) {
         $(this).parent().addClass('has-danger');
         $(this).addClass('form-control-danger');
